...
const styles = {
	...
	feedback_card: "text-md font-extralight p-3 bg-white text-white flex flex-col justify-start items-start rounded",
	card_email: "mt-1 text-sm text-black",
	card_date: "text-xs text-blue-600",
	card_message: "mt-4 text-sm text-gray-500",
